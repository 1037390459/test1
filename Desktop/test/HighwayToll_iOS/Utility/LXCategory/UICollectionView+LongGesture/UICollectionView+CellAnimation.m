//
//  UICollectionViewCell+CellAnimation.m
//  PeacockShop
//
//  Created by Cheng on 17/10/24.
...
@implementation UICollectionView (CellAnimation)
...
- (void)moveAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        UICollectionViewCell *cell = [self.visibleCells objectAtIndex:i];
