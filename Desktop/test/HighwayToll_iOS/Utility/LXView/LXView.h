...
+ (UISearchController *)createSearchDisplayControllerWithSearchBar:(UISearchBar *)searchBar
                                                       contentsController:(UIViewController *)viewController
                                                                 delegate:(id)delegete;

/** 创建UISearchBar */
+ (UISearchController *)createSearchDisplayControllerWithFrame:(CGRect)frame
                                                headerViewOnTableView:(UITableView *)tableView
                                                   contentsController:(UIViewController *)viewController
                                                             delegate:(id)delegete;
