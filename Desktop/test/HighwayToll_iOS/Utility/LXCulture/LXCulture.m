...
+ (NSString *)localizedString:(NSString *)key {
    ...
    NSString *selectedLanguage = [LXCulture getPreferredLanguage];
...
+ (BOOL)isChinese
{
    return ([[LXCulture getPreferredLanguage] isEqualToString:kLMChinese] || [[LXCulture getPreferredLanguage] isEqualToString:kLMChinese2])?YES:NO;
}
