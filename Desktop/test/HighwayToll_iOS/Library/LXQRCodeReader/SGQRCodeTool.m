...
+ (UIImage *)createNonInterpolatedUIImageFormCIImage:(CIImage *)image withSize:(CGFloat)size {
    ...
    UIImage *temImage = [UIImage imageWithCGImage:scaledImage];
...
+ (UIImage *)SG_generateWithLogoQRCodeData:(NSString *)data logoImage:(UIImage *)logoImage logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    ...
    UIImage *icon_image = [SGQRCodeTool createRoundedRectImage:logoImage size:CGSizeMake(icon_imageW, icon_imageH) radius:icon_imageW/6];
